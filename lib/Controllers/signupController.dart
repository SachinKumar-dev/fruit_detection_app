...
import 'package:fruit_detection_app/Models/UserModel.dart';
import 'package:fruit_detection_app/Models/userEmailModel.dart';
  ...
  Future<bool> createUser({documentType}) async {
    ...
    if (selectedFiles.length == 1) {
      try {
        ...
        // bool isVerified = await startEmailVerificationCheck(context);
        // if (isVerified) {
      ...
      Get.snackbar("Warning", "Please pick profile image before registering.",
